...
import sys
sys.path.insert(1, 'C:\\Users\\kimyk\\OneDrive\\Bureau\\Master 1\\Projet_LPHE_I\\ecal_reco\\utils')
...
class Hit:
    ...
    def __init__(self,*args):
        """Creates a Hit from arguments.
            ...
            If five arguments (coordinates, is_sidex, timestamp, evt_timestamp, value), then it simply writes all the parameters
        ...
        Args:
            ...
            evt_timestamp : global timestamp of the hole event
    ...
    def print(self):
        ...
        print("Timestamp event : ", self.evt_timestamp)
